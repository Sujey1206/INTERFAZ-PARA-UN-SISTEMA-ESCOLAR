...
public class ContraseñaDoc extends javax.swing.JFrame {
    Cuentas cu=new Cuentas();
    Mensajes pc = new Mensajes();
    static String pass1,pass2;
    public ContraseñaDoc() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnVolver, new org.netbeans.lib.awtextra.AbsoluteConstraints(1020, 603, -1, -1));
        ...
        jPanel1.add(lblesperando, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 620, 280, 30));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/DOCENTECam1.png"))); // NOI18N
            ...
            if (pass1.isEmpty()) {
                ...
                if (pass2.isEmpty()) {
                    ...
                    if (pass1.compareTo(pass2) != 0) {
                        ...
                        ConsultasCuentas con=new ConsultasCuentas();
                        con.modificar(cu);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ContraseñaDoc().setVisible(true);
            }
        });
    }
